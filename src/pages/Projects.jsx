...
const Projects = () => {
  return (
    <section id="projects" className="flex min-h-screen items-center py-20" data-aos="fade-up">
      <div className="w-full rounded-3xl border border-slate-200/80 bg-white/80 p-10 shadow-lg transition-colors duration-500 dark:border-slate-800/80 dark:bg-slate-900/70">
        ...
        <p className="mt-3 text-lg text-slate-600 dark:text-slate-300">
          Past work includes full-UI rebuilds, performance tuning, and creative marketing prototypes.
        </p>
      </div>
    </section>
  );
